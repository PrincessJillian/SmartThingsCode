...
metadata {
	...
	tiles {
        ...
        {
		    state "closedd", label:'open', action:"switch.off", icon:"st.Home.home9", backgroundColor:"#79b821", nextState:"closedu"
			state "closedu", label:"closed", action:"switch.on", icon:"st.Home.home9", backgroundColor:"#ffffff", nextState:"closedd"
		}
           main "switch"
           details(["switch"])
	}
